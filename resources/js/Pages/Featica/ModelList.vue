<template>
  <div class="py-6 px-4 sm:p-6 lg:pb-8">
    <div>
      <h2 class="text-lg leading-6 font-medium text-gray-900">{{ modelListTitle }}</h2>
      ...
      <div class="max-w-xs w-full lg:max-w-md">
        ...
        <div class="relative text-gray-500 focus-within:text-gray-600">
          ...
          <input ref="searchInput" v-model="form.search" id="search" class="block w-full text-gray-500 bg-white bg-opacity-80 py-2 pl-7 pr-3 border border-transparent rounded-md leading-5 focus:text-gray-900 placeholder-gray400 focus:outline-none focus:bg-opacity-100 focus:border-transparent focus:placeholder-gray-500 focus:ring-0 sm:text-sm" placeholder="Search…" type="search" name="search">
        </div>
      </div>

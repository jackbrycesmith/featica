  ...
  <div>
    <div class="relative sm:bg-red-50 pb-32 overflow-hidden">
      ...
      <div class="absolute flex justify-center inset-x-0 left-1/2 transform -translate-x-1/2 w-full overflow-hidden lg:inset-y-0" aria-hidden="true">
        <div class="flex-grow bg-red-500 bg-opacity-95"></div>
        <svg class="flex-shrink-0" width="1750" height="308" viewBox="0 0 1750 308" xmlns="http://www.w3.org/2000/svg">
          <path opacity=".75" d="M1465.84 308L16.816 0H1750v308h-284.16z" fill="currentColor" class="text-green-500" />
          <path opacity=".95" d="M1733.19 0L284.161 308H0V0h1733.19z" fill="currentColor" class="text-red-500" />
        </svg>
        <div class="flex-grow bg-green-500 bg-opacity-75"></div>
      </div>
    ...
    <main class="relative -mt-32">
      <div class="max-w-screen-xl mx-auto pb-6 px-4 sm:px-6 lg:pb-16 lg:px-8">
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
          <div class="divide-y divide-gray-200 lg:grid lg:grid-cols-12 lg:divide-y-0 lg:divide-x" style="min-height: 80vh;">
            <aside class="py-6 lg:col-span-3">
              <nav>
                ...
                <div title="Models that have feature flags…" class="py-5 relative">
                  <div class="absolute inset-0 flex items-center" aria-hidden="true">
                    <div class="border-gray-200 border-t w-full"></div>
                  </div>
                  <div class="flex justify-center relative">
                    <span class="bg-white pl-3 pr-2 pr-3 text-gray-500 text-sm">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-5 inline-block text-yellow-400 w-5">
